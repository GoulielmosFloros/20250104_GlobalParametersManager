...
import { globalPropsSection } from "../../bim-components";
...
export default (components: OBC.Components) => {
  ...
  // This is added anywhere before the HTML template in the Project Information section.
  const [globalProps] = globalPropsSection({ components });
