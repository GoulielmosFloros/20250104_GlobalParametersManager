...
// Here we just take the GlobalPropertiesManager instance and create two
// global properties in it.
const globalProps = components.get(GlobalPropertiesManager);
globalProps.list.add({ name: "FireRating", type: "IfcLabel" });
globalProps.list.add({ name: "LoadBearing", type: "IfcBoolean" });
